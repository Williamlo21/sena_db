  ...
  <input type="hidden" value="<?= $nAprendiz['id'] ?>" name="id">
    <div class="sm-3">
      ...
      <select class="form-select" id="tipoDocumento" name="tipoDocumento">
        ...
        <option value="0" <?= (isset($nAprendiz['tipoDeDocumento'])) && $nAprendiz['tipoDeDocumento'] == 'NO REGISTRA' ? 'selected' : ''; ?>>NO REGISTRA</option>
        <option value="1" <?= (isset($nAprendiz['tipoDeDocumento'])) && $nAprendiz['tipoDeDocumento'] == 'CEDULA DE CIUDADANIA' ? 'selected' : ''; ?>>CEDULA DE CIUDADANIA</option>
        <option value="2" <?= (isset($nAprendiz['tipoDeDocumento'])) && $nAprendiz['tipoDeDocumento'] == 'TARJETA DE IDENTIDAD' ? 'selected' : ''; ?>>TARJETA DE IDENTIDAD</option>
        <option value="3" <?= (isset($nAprendiz['tipoDeDocumento'])) && $nAprendiz['tipoDeDocumento'] == 'REGISTRO CIVIL' ? 'selected' : ''; ?>>REGISTRO CIVIL</option>
        <option value="4" <?= (isset($nAprendiz['tipoDeDocumento'])) && $nAprendiz['tipoDeDocumento'] == 'CEDULA DE EXTRANJERIA' ? 'selected' : ''; ?>>CEDULA DE EXTRANJERIA</option>
    ...
    <div class="mb-3">
      ...
      <button type="submit" class="btn btn-primary">Editar Aprendiz</button>
  </form>
</div>